...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('map_address', 'zip')

        # Adding field 'Address.input_street'
        db.add_column('map_address', 'input_street', self.gf('django.db.models.fields.CharField')(default='', max_length=200, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Address.zip'
        db.add_column('map_address', 'zip', self.gf('django.db.models.fields.CharField')(default='', max_length=5, db_index=True), keep_default=False)

        # Deleting field 'Address.input_street'
        db.delete_column('map_address', 'input_street')
