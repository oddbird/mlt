...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Parcel.import_timestamp'
        db.add_column('map_parcel', 'import_timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 11, 16, 1, 5, 9, 545922)), keep_default=False)

        # Adding field 'Parcel.deleted'
        db.add_column('map_parcel', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Parcel.import_timestamp'
        db.delete_column('map_parcel', 'import_timestamp')

        # Deleting field 'Parcel.deleted'
        db.delete_column('map_parcel', 'deleted')
