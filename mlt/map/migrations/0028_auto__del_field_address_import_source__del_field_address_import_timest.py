...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Address.import_source'
        db.delete_column('map_address', 'import_source')

        # Deleting field 'Address.import_timestamp'
        db.delete_column('map_address', 'import_timestamp')

        # Deleting field 'Address.imported_by'
        db.delete_column('map_address', 'imported_by_id')

        # Deleting field 'AddressSnapshot.import_source'
        db.delete_column('map_addresssnapshot', 'import_source')

        # Deleting field 'AddressSnapshot.import_timestamp'
        db.delete_column('map_addresssnapshot', 'import_timestamp')

        # Deleting field 'AddressSnapshot.imported_by'
        db.delete_column('map_addresssnapshot', 'imported_by_id')


    def backwards(self, orm):
        
        # Adding field 'Address.import_source'
        db.add_column('map_address', 'import_source', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=100, db_index=True), keep_default=False)

        # Adding field 'Address.import_timestamp'
        db.add_column('map_address', 'import_timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 11, 21, 20, 11, 37, 13357)), keep_default=False)

        # Adding field 'Address.imported_by'
        db.add_column('map_address', 'imported_by', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='address_imported', to=orm['auth.User']), keep_default=False)

        # Adding field 'AddressSnapshot.import_source'
        db.add_column('map_addresssnapshot', 'import_source', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=100, db_index=True), keep_default=False)

        # Adding field 'AddressSnapshot.import_timestamp'
        db.add_column('map_addresssnapshot', 'import_timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 11, 21, 20, 13, 27, 314604)), keep_default=False)

        # Adding field 'AddressSnapshot.imported_by'
        db.add_column('map_addresssnapshot', 'imported_by', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='addresssnapshot_imported', to=orm['auth.User']), keep_default=False)
