...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(model='address', app_label='map')
        perm, created = orm['auth.permission'].objects.get_or_create(content_type=ct, codename='mappings_trusted')
        if created:
            perm.name=u'Can approve addresses and map with no approval.'
            perm.save()
