...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('map_address', 'street', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Address.street'
        db.delete_column('map_address', 'street')
