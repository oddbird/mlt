...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Address.street_suffix'
        db.add_column('map_address', 'street_suffix', self.gf('django.db.models.fields.CharField')(default='', max_length=20, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Address.street_suffix'
        db.delete_column('map_address', 'street_suffix')
