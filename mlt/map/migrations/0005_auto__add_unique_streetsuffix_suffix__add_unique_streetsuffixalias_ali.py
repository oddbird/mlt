...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'StreetSuffix', fields ['suffix']
        db.create_unique('map_streetsuffix', ['suffix'])

        # Adding unique constraint on 'StreetSuffixAlias', fields ['alias']
        db.create_unique('map_streetsuffixalias', ['alias'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'StreetSuffixAlias', fields ['alias']
        db.delete_unique('map_streetsuffixalias', ['alias'])

        # Removing unique constraint on 'StreetSuffix', fields ['suffix']
        db.delete_unique('map_streetsuffix', ['suffix'])
