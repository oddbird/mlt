...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing index on 'AddressBatch', fields ['tag']
        db.delete_index('map_addressbatch', ['tag'])

        # Adding unique constraint on 'AddressBatch', fields ['tag']
        db.create_unique('map_addressbatch', ['tag'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'AddressBatch', fields ['tag']
        db.delete_unique('map_addressbatch', ['tag'])

        # Adding index on 'AddressBatch', fields ['tag']
        db.create_index('map_addressbatch', ['tag'])
