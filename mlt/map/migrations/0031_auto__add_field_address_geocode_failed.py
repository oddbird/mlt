...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Address.geocode_failed'
        db.add_column('map_address', 'geocode_failed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Address.geocode_failed'
        db.delete_column('map_address', 'geocode_failed')
