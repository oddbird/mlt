...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Address.complex'
        db.delete_column('map_address', 'complex_id')

        # Adding field 'Address.complex_name'
        db.add_column('map_address', 'complex_name', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Address.complex'
        db.add_column('map_address', 'complex', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['map.Complex'], null=True), keep_default=False)

        # Deleting field 'Address.complex_name'
        db.delete_column('map_address', 'complex_name')
