...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Parcel', fields ['import_timestamp', 'pl']
        db.create_unique('map_parcel', ['import_timestamp', 'pl'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Parcel', fields ['import_timestamp', 'pl']
        db.delete_unique('map_parcel', ['import_timestamp', 'pl'])
