...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('map_address', 'street', self.gf('mlt.map.fields.CICharField')(max_length=200))

        # Changing field 'AddressSnapshot.street'
        db.alter_column('map_addresssnapshot', 'street', self.gf('mlt.map.fields.CICharField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'Address.street'
        db.alter_column('map_address', 'street', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'AddressSnapshot.street'
        db.alter_column('map_addresssnapshot', 'street', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        'map.address': {
            ...
            'street': ('mlt.map.fields.CICharField', [], {'db_index': 'True', 'max_length': '200', 'blank': 'True'}),
