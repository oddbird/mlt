...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Address.street_suffix_fk'
        db.delete_column('map_address', 'street_suffix_fk_id')


    def backwards(self, orm):
        
        # Adding field 'Address.street_suffix_fk'
        db.add_column('map_address', 'street_suffix_fk', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['map.StreetSuffix']), keep_default=False)
