...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Address.street_prefix'
        db.add_column('map_address', 'street_prefix', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=20, blank=True), keep_default=False)

        # Adding field 'Address.street_type'
        db.add_column('map_address', 'street_type', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=20, blank=True), keep_default=False)

        # Adding field 'Address.parsed_street'
        db.add_column('map_address', 'parsed_street', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Address.street_prefix'
        db.delete_column('map_address', 'street_prefix')

        # Deleting field 'Address.street_type'
        db.delete_column('map_address', 'street_type')

        # Deleting field 'Address.parsed_street'
        db.delete_column('map_address', 'parsed_street')
