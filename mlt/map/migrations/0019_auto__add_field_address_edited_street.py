...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Address.edited_street'
        db.add_column('map_address', 'edited_street', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Address.edited_street'
        db.delete_column('map_address', 'edited_street')
