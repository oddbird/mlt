...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing index on 'Address', fields ['street_name']
        db.delete_index('map_address', ['street_name'])

        # Removing index on 'Address', fields ['street_number']
        db.delete_index('map_address', ['street_number'])

        # Removing index on 'Address', fields ['street_suffix']
        db.delete_index('map_address', ['street_suffix'])

        # Removing index on 'Address', fields ['street_prefix']
        db.delete_index('map_address', ['street_prefix'])

        # Removing index on 'Address', fields ['street_type']
        db.delete_index('map_address', ['street_type'])


    def backwards(self, orm):
        
        # Adding index on 'Address', fields ['street_type']
        db.create_index('map_address', ['street_type'])

        # Adding index on 'Address', fields ['street_prefix']
        db.create_index('map_address', ['street_prefix'])

        # Adding index on 'Address', fields ['street_suffix']
        db.create_index('map_address', ['street_suffix'])

        # Adding index on 'Address', fields ['street_number']
        db.create_index('map_address', ['street_number'])

        # Adding index on 'Address', fields ['street_name']
        db.create_index('map_address', ['street_name'])
